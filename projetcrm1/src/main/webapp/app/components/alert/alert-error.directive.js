(function() {
    ...
    function jhiAlertErrorController ($scope, AlertService, $rootScope) {
        ...
        var cleanHttpErrorListener = $rootScope.$on('projetcrm1App.httpError', function (event, httpResponse) {
            var i;
            ...
            case 400:
                var errorHeader = httpResponse.headers('X-projetcrm1App-error');
                var entityKey = httpResponse.headers('X-projetcrm1App-params');
                if (errorHeader) {
